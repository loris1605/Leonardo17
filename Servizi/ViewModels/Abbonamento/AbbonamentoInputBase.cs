...
{
    public partial class AbbonamentoInputBase : InputViewModel<ServiziTipoAbbonamentoMap>
    {
        ...
        public string Name => BindingT.NomeAbbonamento.Trim() is null ? "" : BindingT.NomeAbbonamento.Trim();
        
        protected int GetCodiceAbbonamento => BindingT is null ? 0 : BindingT.Id;
    ...
    public partial class AbbonamentoInputBase
    {
