...
{
    public class ConfigurazionePostazioneMap : BindableMap
    {
        public ConfigurazionePostazioneMap() { }

        public ConfigurazionePostazioneMap(ConfigurazionePostazioneDTO dto)
        {
            this.Id = dto.Id;
        ...
        public ConfigurazionePostazioneDTO ToDto()
        {
            return new ConfigurazionePostazioneDTO
            {
                Id = this.Id,
