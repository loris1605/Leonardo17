...
{
    public class ConfigurazionePostazioneDTO : BaseDTO, IMap, IMappable<Postazione>
    {
        ...
        public ConfigurazionePostazioneDTO() { }

        public ConfigurazionePostazioneDTO(Postazione table)
        {
            this.Id = table.Id;
        ...
        public static Expression<Func<Postazione, ConfigurazionePostazioneDTO>> ToPostazioneDto => entity => 
        ...
        public static Expression<Func<Postazione, Reparto, ConfigurazionePostazioneDTO>> ToPostazioniDtoRelationed =>
        (o, p) => new ConfigurazionePostazioneDTO
        {
            Id = o.Id,
        ...
        public static Expression<Func<Permesso, ConfigurazionePostazioneDTO>> ToPermessoDTO => p => new ConfigurazionePostazioneDTO
        {
            Id = p.Id,
